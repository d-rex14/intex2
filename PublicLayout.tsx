            ...
            <div className="hidden md:flex items-center gap-3">
              {session ? (
                ...
                <>
                  <Link
                    to="/login"
                    className="text-sm font-medium text-[#8da0c4] hover:text-white transition-colors"
                  >
                    Sign In
                  </Link>
                  <Link
            ...
            {navLinks.map(link => (
              <Link
                ...
                className={`text-sm font-medium py-2 ${
                  isActive(link.to) ? 'text-amber-400' : 'text-[#8da0c4]'
                }`}
              >
                {link.label}
              </Link>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 text-xs text-[#4a5a7a]">
              <Link to="/privacy" className="hover:text-[#8da0c4] transition-colors">Privacy Policy</Link>
