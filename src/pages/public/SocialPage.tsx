...
export function SocialPage() {
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <p className="mt-2 text-[var(--wt-text-2)] max-w-2xl">Videos and updates from Watchtower Sanctuary.</p>
      ...
      <h2 className="mt-12 font-display text-xl font-bold text-[var(--wt-text)]">
        For the most updated information check out our Watchtower Sanctuary Facebook page
      </h2>
